...
Lab Technicians: C. Steel, E. Lutz, T. Chou, A. Carter
...
Table name: 2008_Palmyra_Algae_Isotopes.xlsx
Table Description: This is marine baseline data from Palmyra for correcting nitrogen isotopes of consumers

Column name | Description | Unit or code explanation or date format | missing value code

Date | The date the sample was processed on the analyzer | DD/MM/YY | NA

ID#1 | a sample ID assigned to each sample prior to processing | NA |NA 

ID#2 | a biological sample ID for each sample | NA | NA

ID#3 | Additional site description ID for each sample | NA | no site identifier specified

Wt(mg) | the weight of the initial sample submitted to the analyzer | milligrams | NA

Amp(V) N | The raw output of nitrogen measurement generated by  the mass spectrometer | NA | NA 

Amp(V) C | The raw output of carbon measurement generated by the mass spectrometer | NA | NA

Wt. % N | The converted (by weight) nitrogen content in the sample from the raw nitrogen output | NA | NA 

Wt. % C | The converted (by weight) carbon content in the sample from the raw carbon output | NA | NA 

d15N Air | The uncorrected d15N measurement for each sample | NA | NA

d13C PDB | The d13C measurement for each sample | NA | NA

C:N Atomic | The ratio of carbon to nitrogen in the sample | NA | NA

Run | The internal run ID from the mass spectrometer operator | NA | NA

Table name: 2008_Palmyra_Guano_Isotopes.xlsx
Table Description: This is guano baseline data from Palmyra for correcting nitrogen isotopes of consumers 

Column name | Description | Unit or code explanation or date format | missing value explanation
...
ID#3 | Additional biological description ID for each sample | NA | no site identifier specified

Wt(mg) | the weight of the initial sample submitted to the analyzer | milligrams | NA

Amp(V) N | The raw output of nitrogen measurement generated by  the mass spectrometer | NA | could not be calculated for this sample

Amp(V) C | The raw output of carbon measurement generated by the mass spectrometer | NA | could not be calculated for this sample

Wt. % N | The converted (by weight) nitrogen content in the sample from the raw nitrogen output | NA | could not be calculated for this sample

Wt. % C | The converted (by weight) carbon content in the sample from the raw carbon output | NA | could not be calculated for this sample

d15N Air | The uncorrected d15N measurement for each sample | NA | could not be calculated for this sample

d13C PDB | The d13C measurement for each sample | NA | could not be calculated for this sample

C:N Atomic | The ratio of carbon to nitrogen in the sample | NA | could not be calculated for this sample

Run | The internal run ID from the mass spectrometer operator | NA | NA


Table name: 2009-2012 Palmyra Plant Isotope Data.csv
Table Description: Terrestrial plant baseline isotope data for correcting nitrogen isotopes of consumers

Column name | Description | Unit or code explanation or date format | missing value code

Species | The species of plant corresponding to the sample | NA | NA

Date | The year in which the sample was collected | YYYY | NA

Island Name | The islet site location ID where the sample was collected | NA | NA
...
d15N | The uncorrected d15N measurement for each sample | NA | could not be calculated for this sample


d13C | The d13C measurement for each sample | NA | could not be calculated for this sample


C:N | The ratio of carbon to nitrogen in the sample | NA | could not be calculated for this sample


top:

Table name: 2009-2015_Cane Spider Isotopes.csv
Table description: Top predator consumer isotope data, including carbon and nitrogen isotopes

Column name | Description | Unit or code explanation or date format | missing value code

ID | The unique sample identifier for each top predator sample | NA | NA

Amount_ug | The initial amount of sample submitted to the mass spectrometer for analyses | micrograms | value was not calculated in this unit 
...
Amount_mg  | the weight of the initial sample submitted to the analyzer | milligrams | the sample was not submitted with this weight unit

Total_N_ug | The weight of nitrogen in the sample | micrograms | this value was not calculated for the sample 

Total_C_ug | The weight of carbon in the sample | micrograms | this value was not calculated for the sample 

Subfolder: size

Table name: Spider sizes 2009-2015.csv
Table description: These are body size measurements for top predators

Column name | Description | Unit or code explanation or date format | missing value code

Island | the islet on which the spider was collected, these are just for top predators Heteropoda venatoria | NA |NA

Year | The year in which the spider was collected | NA |NA 

ID | The ID of that spiderfrom that islet | NA |NA 

Length_mm | The length from the top of the cephalothorax to the end of the abdomen for each spider | millimeters | this measurement was not taken for this individual

Mass_g | The mass (wet) of the spider | grams | this measurement was not taken for this individual

### 

Scripts/code (software)

Subfolder: 00_functions

File name: tidy_functions.R
File description: This is a set of functions that help with data cleaning and tidying
Category: data tidying
Scripting language: R

Subfolder: 01_cleaning

File name: int_DNA.R
File description: this is code for organizing and cleaning the predator-prey interactions for secondary predators
Category: Data cleaning
Scripting language: R

File name: top_DNA.R
File description: This is code for organizing and cleaning the predator-prey interactions for top predators
Category: Data cleaning
Scripting language: R

File name: top_isotopes.R
File description: This is code for organizing and cleaning the stable isotope data for the top predators
Category: Data cleaning
Scripting language: R

Subfolder: 02_analyses

File name: community_analyses.R
File description: This is code to reproduce the community analyses related to beta diversity
Category: Data analysis
Scripting language: R

File name: isotope_glms.R
File description: This is code to reproduce the analysis of individual isotope values for top predators
Category: Data analysis
Scripting language: R

File name: isotope_niches.R
File description: This is code to reproduce the analysis of isotopic niche spaces for top predators
Category: Data analysis
Scripting language: R

Subfolder: 03_figures

File name: draft_figures_AB_2022-03-18.R
File description: This is code to reproduce the figures for the paper
